...
##    ssl_dh_client_params ssl_ecdh_server_params ssl_ecdh_client_params
##    ssl_rsa_client_pms ssl_server_signature
global ssl_extension_signature_algorithm: event(c: connection , is_orig: bool , signature_algorithms: signature_and_hashalgorithm_vec );
...
##    ssl_dh_client_params ssl_ecdh_server_params ssl_ecdh_client_params
##    ssl_rsa_client_pms ssl_server_signature
global ssl_extension_key_share: event(c: connection , is_orig: bool , curves: index_vec );
...
##    ssl_dh_client_params ssl_ecdh_server_params ssl_ecdh_client_params
##    ssl_rsa_client_pms ssl_server_signature
global ssl_server_curve: event(c: connection , curve: count ) &deprecated;
...
global ssl_extension_signed_certificate_timestamp: event(c: connection , is_orig: bool , version: count , logid: string , timestamp: count , signature_and_hashalgorithm: SSL::SignatureAndHashAlgorithm , signature: string );
...
global ssl_extension_supported_versions: event(c: connection , is_orig: bool , versions: index_vec );
...
global ssl_extension_psk_key_exchange_modes: event(c: connection , is_orig: bool , modes: index_vec );
...
global ssl_application_data: event(c: connection , is_orig: bool , length: count );
