...
export {
global ocsp_request: event(f: fa_file , version: count , requestorName: string );
...
##              x509_ocsp_ext_signed_certificate_timestamp
global ocsp_response_bytes: event(f: fa_file , resp_ref: opaque of ocsp_resp , status: string , version: count , responderId: string , producedAt: time , signatureAlgorithm: string , certs: x509_opaque_vector );
