...
namespace plugin { namespace Bro_GSSAPI { class Plugin; extern Plugin plugin; } };
...
namespace plugin { namespace Bro_IMAP { class Plugin; extern Plugin plugin; } };
...
namespace plugin { namespace Bro_NTLM { class Plugin; extern Plugin plugin; } };
...
namespace plugin { namespace Bro_RFB { class Plugin; extern Plugin plugin; } };
...
namespace plugin { namespace Bro_XMPP { class Plugin; extern Plugin plugin; } };
...
namespace plugin { namespace Bro_FileEntropy { class Plugin; extern Plugin plugin; } };
...
namespace plugin { namespace Bro_ConfigReader { class Plugin; extern Plugin plugin; } };
...
i += (size_t)(&(plugin::Bro_GSSAPI::plugin));
...
i += (size_t)(&(plugin::Bro_IMAP::plugin));
...
i += (size_t)(&(plugin::Bro_NTLM::plugin));
...
i += (size_t)(&(plugin::Bro_RFB::plugin));
...
i += (size_t)(&(plugin::Bro_ConfigReader::plugin));
