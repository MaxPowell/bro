// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/ayiya/ayiya.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/ayiya/ayiya_pac.h"
...
int PDU::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextAYIYA * t_context)
	...
	if ( (t_begin_of_data + 8) + (t_identity__size) > t_end_of_data || (t_begin_of_data + 8) + (t_identity__size) < (t_begin_of_data + 8) )
		{
		// Handle out-of-bound condition
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/ayiya/ayiya-protocol.pac:8", t_identity_string_length);
	...
	if ( t_dataptr_after_identity + (t_signature__size) > t_end_of_data || t_dataptr_after_identity + (t_signature__size) < t_dataptr_after_identity )
		{
		// Handle out-of-bound condition
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/ayiya/ayiya-protocol.pac:9", t_signature_string_length);
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/ayiya/ayiya-protocol.pac:10", t_packet_string_length);
