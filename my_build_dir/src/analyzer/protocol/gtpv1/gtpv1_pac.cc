// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/gtpv1/gtpv1_pac.h"
...
int GTPv1_Header::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextGTPv1 * t_context)
	...
	switch ( msg_case_index() )
		...
		case 255:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:25", t_packet_string_length);
		...
		default:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:26", t_unknown_string_length);
...
int GTPv1_Ext_Header::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:47", t_contents_string_length);
...
int InformationElement::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, int t_byteorder)
	...
	switch ( value_case_index() )
		...
		default:
			...
			// check for negative sizes
			if ( t_unknown_string_length < 0 )
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:153", t_unknown_string_length);
...
int IMSI::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_tbcd_encoded_value__arraylength > t_end_of_data + 1 || t_begin_of_data + t_tbcd_encoded_value__arraylength < t_begin_of_data )
		{
...
int EndUserAddr::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:322", t_pdp_addr_string_length);
...
int MM_Ctx::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, int t_byteorder)
	...
	switch ( vectors_case_index() )
		...
		case 1:
			...
			if ( t_begin_of_data + t_triplets__arraylength > t_end_of_data + 1 || t_begin_of_data + t_triplets__arraylength < t_begin_of_data )
				{
		...
		case 0:
			...
			if ( t_begin_of_data + t_quintuplets__arraylength > t_end_of_data + 1 || t_begin_of_data + t_quintuplets__arraylength < t_begin_of_data )
				{
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:348", t_ms_net_capability_string_length);
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:350", t_container_string_length);
...
int PDP_Ctx::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, int t_byteorder)
	...
	// check for negative sizes
	if ( t_pdp_addr_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:378", t_pdp_addr_string_length);
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:380", t_ggsn_addr_control_plane_string_length);
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:382", t_ggsn_addr_user_traffic_string_length);
...
int AP_Name::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:390", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int ProtoConfigOpts::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:394", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int GSN_Addr::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:398", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int MSISDN::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:402", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int QoS_Profile::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:407", t_data_string_length);
...
int AuthN_Quintuplet::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:413", t_xres_string_length);
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:417", t_autn_string_length);
...
int TrafficFlowTemplate::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:421", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int TargetID::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:425", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int UTRAN_TransparentContainer::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:429", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int RAB_SetupInfo::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, int t_byteorder)
	...
	switch ( have_addr_case_index() )
		...
		default:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:442", t_rnc_addr_string_length);
...
int ExtHdrTypeList::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_value__arraylength > t_end_of_data + 1 || t_begin_of_data + t_value__arraylength < t_begin_of_data )
		{
	...
	for (; t_value__elem__it < t_value__arraylength; ++t_value__elem__it)
		...
		if ( t_value__elem__dataptr + (1) > t_end_of_data || t_value__elem__dataptr + (1) < t_value__elem__dataptr )
			{
			// Handle out-of-bound condition
...
int TriggerID::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:451", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int OMC_ID::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:455", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int ChargingGatewayAddr::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:459", t_value_string_length);
	value_.init(t_begin_of_data, t_value_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int PrivateExt::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, int t_byteorder)
	...
	// check for negative sizes
	if ( t_value_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:464", t_value_string_length);
...
uint16 Get_IE_Len(uint8 t)
	...
	switch ( t )
		...
		case 127:
			...
			break;
		default:
			throw binpac::ExceptionInvalidCaseIndex("/home/ubuntu/bro/src/analyzer/protocol/gtpv1/gtpv1-protocol.pac:496", t);
			break;
		}
