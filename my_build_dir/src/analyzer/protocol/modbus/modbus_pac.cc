// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/modbus/modbus.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/modbus/modbus_pac.h"
...
int ModbusTCP_Request::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	switch ( val_case_index() )
		...
		default:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/modbus/modbus-protocol.pac:103", t_unknown_string_length);
...
int ModbusTCP_Response::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	switch ( val_case_index() )
		...
		default:
			...
			// check for negative sizes
			if ( t_unknown_string_length < 0 )
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/modbus/modbus-protocol.pac:145", t_unknown_string_length);
			unknown_.init(t_begin_of_data, t_unknown_string_length);
			// Evaluate 'let' and 'withinput' fields
			t_val__size = t_unknown__size;
			}
...
int ReadCoilsResponse::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/modbus/modbus-protocol.pac:165", t_bits_string_length);
...
int ReadDiscreteInputsResponse::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	// check for negative sizes
	if ( t_bits_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/modbus/modbus-protocol.pac:181", t_bits_string_length);
	bits_.init((t_begin_of_data + 1), t_bits_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int ReadHoldingRegistersResponse::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	if ( t_begin_of_data + t_registers__arraylength > t_end_of_data + 1 || t_begin_of_data + t_registers__arraylength < t_begin_of_data )
		{
...
int WriteMultipleCoilsRequest::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/modbus/modbus-protocol.pac:255", t_coils_string_length);
...
int FileRecordResponse::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_record_data__arraylength > t_end_of_data + 1 || t_begin_of_data + t_record_data__arraylength < t_begin_of_data )
		{
...
int ReferenceWithData::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_register_value__arraylength > t_end_of_data + 1 || t_begin_of_data + t_register_value__arraylength < t_begin_of_data )
		{
	...
	for (; t_register_value__elem__it < t_register_value__arraylength; ++t_register_value__elem__it)
		...
		if ( t_register_value__elem__dataptr + (2) > t_end_of_data || t_register_value__elem__dataptr + (2) < t_register_value__elem__dataptr )
			{
			// Handle out-of-bound condition
...
int ReadWriteMultipleRegistersRequest::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	if ( t_begin_of_data + t_write_register_values__arraylength > t_end_of_data + 1 || t_begin_of_data + t_write_register_values__arraylength < t_begin_of_data )
		{
...
int ReadFIFOQueueResponse::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextModbusTCP * t_context)
	...
	if ( t_begin_of_data + t_register_data__arraylength > t_end_of_data + 1 || t_begin_of_data + t_register_data__arraylength < t_begin_of_data )
		{
