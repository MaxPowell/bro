...
#if defined(BRO_IN_NETVAR) || ! defined(_home_ubuntu_bro_my_build_dir_src_analyzer_protocol_rpc_events_bif)
#ifndef BRO_IN_NETVAR
#ifndef _home_ubuntu_bro_my_build_dir_src_analyzer_protocol_rpc_events_bif
#define _home_ubuntu_bro_my_build_dir_src_analyzer_protocol_rpc_events_bif
#include "bro-bif.h"
#endif
#endif
...
extern EventHandlerPtr nfs_proc_sattr; 
namespace BifEvent {  void generate_nfs_proc_sattr(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep);  } 
...
extern EventHandlerPtr nfs_proc_symlink; 
namespace BifEvent {  void generate_nfs_proc_symlink(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep);  } 
extern EventHandlerPtr nfs_proc_link; 
namespace BifEvent {  void generate_nfs_proc_link(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep);  } 
...
extern EventHandlerPtr nfs_proc_rename; 
namespace BifEvent {  void generate_nfs_proc_rename(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep);  } 
...
extern EventHandlerPtr mount_proc_null; 
namespace BifEvent {  void generate_mount_proc_null(analyzer::Analyzer* analyzer, Connection* c, Val* info);  } 
extern EventHandlerPtr mount_proc_mnt; 
namespace BifEvent {  void generate_mount_proc_mnt(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep);  } 
extern EventHandlerPtr mount_proc_umnt; 
namespace BifEvent {  void generate_mount_proc_umnt(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req);  } 
extern EventHandlerPtr mount_proc_umnt_all; 
namespace BifEvent {  void generate_mount_proc_umnt_all(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req);  } 
extern EventHandlerPtr mount_proc_not_implemented; 
namespace BifEvent {  void generate_mount_proc_not_implemented(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* proc);  } 
extern EventHandlerPtr mount_reply_status; 
namespace BifEvent {  void generate_mount_reply_status(analyzer::Analyzer* analyzer, Connection* n, Val* info);  } 
