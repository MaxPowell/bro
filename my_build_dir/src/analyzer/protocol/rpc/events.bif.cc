...
EventHandlerPtr nfs_proc_sattr; 
void BifEvent::generate_nfs_proc_sattr(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep)
	{
	// Note that it is intentional that here we do not
	// check if ::nfs_proc_sattr is NULL, which should happen *before*
	// BifEvent::generate_nfs_proc_sattr is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::nfs_proc_sattr, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
...
EventHandlerPtr nfs_proc_symlink; 
void BifEvent::generate_nfs_proc_symlink(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep)
	{
	// Note that it is intentional that here we do not
	// check if ::nfs_proc_symlink is NULL, which should happen *before*
	// BifEvent::generate_nfs_proc_symlink is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::nfs_proc_symlink, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
EventHandlerPtr nfs_proc_link; 
void BifEvent::generate_nfs_proc_link(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep)
	{
	// Note that it is intentional that here we do not
	// check if ::nfs_proc_link is NULL, which should happen *before*
	// BifEvent::generate_nfs_proc_link is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::nfs_proc_link, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
...
EventHandlerPtr nfs_proc_rename; 
void BifEvent::generate_nfs_proc_rename(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep)
	{
	// Note that it is intentional that here we do not
	// check if ::nfs_proc_rename is NULL, which should happen *before*
	// BifEvent::generate_nfs_proc_rename is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::nfs_proc_rename, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
...
EventHandlerPtr mount_proc_null; 
void BifEvent::generate_mount_proc_null(analyzer::Analyzer* analyzer, Connection* c, Val* info)
	{
	// Note that it is intentional that here we do not
	// check if ::mount_proc_null is NULL, which should happen *before*
	// BifEvent::generate_mount_proc_null is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::mount_proc_null, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
EventHandlerPtr mount_proc_mnt; 
void BifEvent::generate_mount_proc_mnt(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req, Val* rep)
	{
	// Note that it is intentional that here we do not
	// check if ::mount_proc_mnt is NULL, which should happen *before*
	// BifEvent::generate_mount_proc_mnt is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::mount_proc_mnt, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
EventHandlerPtr mount_proc_umnt; 
void BifEvent::generate_mount_proc_umnt(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req)
	{
	// Note that it is intentional that here we do not
	// check if ::mount_proc_umnt is NULL, which should happen *before*
	// BifEvent::generate_mount_proc_umnt is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::mount_proc_umnt, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
EventHandlerPtr mount_proc_umnt_all; 
void BifEvent::generate_mount_proc_umnt_all(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* req)
	{
	// Note that it is intentional that here we do not
	// check if ::mount_proc_umnt_all is NULL, which should happen *before*
	// BifEvent::generate_mount_proc_umnt_all is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::mount_proc_umnt_all, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
EventHandlerPtr mount_proc_not_implemented; 
void BifEvent::generate_mount_proc_not_implemented(analyzer::Analyzer* analyzer, Connection* c, Val* info, Val* proc)
	{
	// Note that it is intentional that here we do not
	// check if ::mount_proc_not_implemented is NULL, which should happen *before*
	// BifEvent::generate_mount_proc_not_implemented is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::mount_proc_not_implemented, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, c);
	} // event generation
EventHandlerPtr mount_reply_status; 
void BifEvent::generate_mount_reply_status(analyzer::Analyzer* analyzer, Connection* n, Val* info)
	{
	// Note that it is intentional that here we do not
	// check if ::mount_reply_status is NULL, which should happen *before*
	// BifEvent::generate_mount_reply_status is called to avoid unnecessary Val
	// allocation.
	...
	mgr.QueueEvent(::mount_reply_status, vl, SOURCE_LOCAL, analyzer->GetID(), timer_mgr, n);
	} // event generation
