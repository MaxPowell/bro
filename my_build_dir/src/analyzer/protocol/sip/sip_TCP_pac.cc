// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/sip/sip_TCP.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/sip/sip_TCP_pac.h"
...
namespace SIP_TCP {
ContextSIP_TCP::ContextSIP_TCP(SIP_Conn * connection, SIP_Flow * flow, FlowBuffer * flow_buffer)
	{
...
bool SIP_PDU::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
...
bool SIP_Request::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
...
bool SIP_Reply::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	switch ( parsing_state_ ) {
...
int SIP_RequestLine::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSIP_TCP * t_context)
	{
	// Parse "method"
...
int SIP_ReplyLine::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSIP_TCP * t_context)
	{
	// Parse "version"
	version_ = new SIP_Version();
	int t_version__size;
...
bool SIP_Headers::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	if ( val__elem__it_ < 0 )
...
bool SIP_Message::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	switch ( parsing_state_ ) {
...
bool SIP_Header::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	const_byteptr t_begin_of_data = t_flow_buffer->begin();
...
bool SIP_Body::ParseBuffer(flow_buffer_t t_flow_buffer, ContextSIP_TCP * t_context)
	{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	switch ( parsing_state_ ) {
	...
	try
		...
		while ( flow_buffer_->data_available() && 
			...
			if ( ! dataunit_ )
				...
				context_ = new ContextSIP_TCP(connection(), this, flow_buffer());
				}
