// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/syslog/syslog.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/syslog/syslog_pac.h"
...
int Syslog_Message::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSyslog * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/syslog/syslog-protocol.pac:3", t_msg_string_length);
...
int Syslog_Priority::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_val_string_length < 0 )
		{
		throw binpac::ExceptionStringMismatch("/home/ubuntu/bro/src/analyzer/protocol/syslog/syslog-protocol.pac:8", "[[:digit:]]+", string((const char *) ((t_begin_of_data + 1)), (const char *) t_end_of_data).c_str());
		}
	int t_val__size;
	t_val__size = t_val_string_length;
	// check for negative sizes
	if ( t_val_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/syslog/syslog-protocol.pac:8", t_val_string_length);
	...
	if ( t_dataptr_after_val + (1) > t_end_of_data || t_dataptr_after_val + (1) < t_dataptr_after_val )
		{
		// Handle out-of-bound condition
