...
void BifEvent::generate_dnp3_application_request_header(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t application, bro_uint_t fc)
	{
	...
	vl->append(new Val(application, TYPE_COUNT));
...
void BifEvent::generate_dnp3_application_response_header(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t application, bro_uint_t fc, bro_uint_t iin)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_header_block(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t len, bro_uint_t ctrl, bro_uint_t dest_addr, bro_uint_t src_addr)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_counter_32wFlagTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t count_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
	...
	vl->append(new Val(flag, TYPE_COUNT));
	vl->append(new Val(count_value, TYPE_COUNT));
	vl->append(new Val(time48, TYPE_COUNT));
...
void BifEvent::generate_dnp3_frozen_counter_16wFlagTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t count_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_analog_input_32wTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t frozen_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_analog_input_16wTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t frozen_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_analog_input_event_32wTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_analog_input_event_16wTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_analog_input_event_SPwTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_analog_input_event_DPwTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t value_low, bro_uint_t value_high, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_analog_input_event_32wTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t frozen_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_analog_input_event_16wTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t frozen_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_analog_input_event_SPwTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t frozen_value, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
...
void BifEvent::generate_dnp3_frozen_analog_input_event_DPwTime(analyzer::Analyzer* analyzer, Connection* c, int is_orig, bro_uint_t flag, bro_uint_t frozen_value_low, bro_uint_t frozen_value_high, bro_uint_t time48)
	{
	// Note that it is intentional that here we do not
