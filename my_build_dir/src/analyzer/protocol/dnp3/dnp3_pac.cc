// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/dnp3/dnp3_pac.h"
...
int Header_Block::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context)
	...
	// Parse "start_1"
	start_1_ = *((uint8 const *) (t_begin_of_data));
	// Evaluate 'let' and 'withinput' fields
	...
	// Parse "start_2"
	start_2_ = *((uint8 const *) ((t_begin_of_data + 1)));
	// Evaluate 'let' and 'withinput' fields
	// Evaluate '&enforce' attribute
	if (! ( start_2() == 0x64 ) )
		{
			...
			if ( t_flow_buffer->ready() )
				...
				switch ( data_case_index() )
					...
					default:
						...
						throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-protocol.pac:57", t_unknown_string_length);
...
int Debug_Byte::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-protocol.pac:63", t_debug_string_length);
...
int Request_Objects::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context, int t_byteorder)
	...
	switch ( data_case_index() )
		...
		case 3075:
			...
			if ( t_begin_of_data + t_bocmd_PM__arraylength > t_end_of_data + 1 || t_begin_of_data + t_bocmd_PM__arraylength < t_begin_of_data )
				{
		...
		case 12802:
			...
			if ( t_begin_of_data + t_time_interval_ojbects__arraylength > t_end_of_data + 1 || t_begin_of_data + t_time_interval_ojbects__arraylength < t_begin_of_data )
				{
		...
		default:
			...
			if ( t_begin_of_data + t_ojbects__arraylength > t_end_of_data + 1 || t_begin_of_data + t_ojbects__arraylength < t_begin_of_data )
				{
...
int Response_Objects::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context, int t_byteorder)
	...
	switch ( data_case_index() )
		...
		case 257:
			...
			if ( t_begin_of_data + t_biwoflag__arraylength > t_end_of_data + 1 || t_begin_of_data + t_biwoflag__arraylength < t_begin_of_data )
				{
		...
		case 769:
			...
			if ( t_begin_of_data + t_diwoflag__arraylength > t_end_of_data + 1 || t_begin_of_data + t_diwoflag__arraylength < t_begin_of_data )
				{
		...
		case 2561:
			...
			if ( t_begin_of_data + t_bowoflag__arraylength > t_end_of_data + 1 || t_begin_of_data + t_bowoflag__arraylength < t_begin_of_data )
				{
...
int Object_Header::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context, int t_byteorder)
	...
	switch ( range_field_case_index() )
		...
		default:
			...
			// check for negative sizes
			if ( t_unknown_string_length < 0 )
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-protocol.pac:139", t_unknown_string_length);
...
int Request_Data_Object::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context, int t_byteorder)
	...
	switch ( data_case_index() )
		...
		case 20481:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:278", t_iin_string_length);
...
int Response_Data_Object::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context, int t_byteorder)
	...
	switch ( data_case_index() )
		...
		case 769:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:390", t_dbibytes_string_length);
...
int Default_Wrap::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context)
	...
	switch ( unresolved_case_index() )
		...
		case 28160:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:622", t_oct_str_string_length);
		...
		case 28416:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:623", t_oct_str_eve_string_length);
		...
		case 28672:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:624", t_vir_ter_out_blk_string_length);
		...
		case 28928:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:625", t_vir_ter_eve_string_length);
...
int AttributeCommon::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:640", t_attribute_obj_string_length);
...
int Record_Obj::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1158", t_record_oct_string_length);
...
int File_Control_ID::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1175", t_file_name_string_length);
...
int File_Control_Auth::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1193", t_usr_name_string_length);
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1194", t_pwd_string_length);
...
int File_Control_Cmd::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_file_name_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1217", t_file_name_string_length);
	file_name_.init((t_dataptr_after_time_create + 16), t_file_name_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int File_Control_Cmd_Status::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1236", t_opt_text_string_length);
...
int File_Transport::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextDNP3 * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1244", t_file_data_string_length);
...
int File_Transport_Status::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_opt_text_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1253", t_opt_text_string_length);
...
int File_Desc::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1273", t_f_name_string_length);
...
int File_Spec_Str::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1278", t_f_spec_string_length);
...
int Dev_Profile::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_dev_headers__arraylength > t_end_of_data + 1 || t_begin_of_data + t_dev_headers__arraylength < t_begin_of_data )
		{
...
int PrivRegObj::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1312", t_data_objs_string_length);
...
int PrivRegObjDesc::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_data_objs__arraylength > t_end_of_data + 1 || t_begin_of_data + t_data_objs__arraylength < t_begin_of_data )
		{
...
int App_Id::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	switch ( app_id_case_index() )
		...
		case 91:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1353", t_app_name_string_length);
...
int ActivateConf::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_elements__arraylength > t_end_of_data + 1 || t_begin_of_data + t_elements__arraylength < t_begin_of_data )
		{
...
int StatusEle::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1369", t_ancillary_string_length);
...
int AuthChallenge::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( (t_begin_of_data + 5) + (1) > t_end_of_data || (t_begin_of_data + 5) + (1) < (t_begin_of_data + 5) )
		{
		// Handle out-of-bound condition
	...
	if ( (t_begin_of_data + 6) + (t_chan_data__size) > t_end_of_data || (t_begin_of_data + 6) + (t_chan_data__size) < (t_begin_of_data + 6) )
		{
		// Handle out-of-bound condition
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1387", t_chan_data_string_length);
...
int AuthRely::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( (t_begin_of_data + 4) + (t_chan_data__size) > t_end_of_data || (t_begin_of_data + 4) + (t_chan_data__size) < (t_begin_of_data + 4) )
		{
		// Handle out-of-bound condition
	...
	// check for negative sizes
	if ( t_chan_data_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1393", t_chan_data_string_length);
...
int AuthAggrRequest::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_chan_data_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1399", t_chan_data_string_length);
	chan_data_.init((t_begin_of_data + 4), t_chan_data_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int AuthSessionKeyStatus::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	// check for negative sizes
	if ( t_chan_data_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1407", t_chan_data_string_length);
	chan_data_.init((t_begin_of_data + 6), t_chan_data_string_length);
	// Evaluate 'let' and 'withinput' fields
	}
...
int AuthSessionKeyChange::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( (t_begin_of_data + 4) + (t_key_wrap_data__size) > t_end_of_data || (t_begin_of_data + 4) + (t_key_wrap_data__size) < (t_begin_of_data + 4) )
		{
		// Handle out-of-bound condition
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1413", t_key_wrap_data_string_length);
...
int AuthError::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( (t_begin_of_data + 5) + (t_key_wrap_data__size) > t_end_of_data || (t_begin_of_data + 5) + (t_key_wrap_data__size) < (t_begin_of_data + 5) )
		{
		// Handle out-of-bound condition
	...
	// check for negative sizes
	if ( t_key_wrap_data_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/dnp3/dnp3-objects.pac:1420", t_key_wrap_data_string_length);
