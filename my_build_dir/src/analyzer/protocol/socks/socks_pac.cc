// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/socks/socks.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/socks/socks_pac.h"
...
int SOCKS_Message::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSOCKS * t_context)
	...
	switch ( val_case_index() )
		...
		case 0:
			...
			break;
		default:
			throw binpac::ExceptionInvalidCaseIndex("SOCKS_Message", val_case_index());
			break;
		}
	// Evaluate 'let' and 'withinput' fields
...
int SOCKS5_Auth_Negotiation_Request::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + t_methods__arraylength > t_end_of_data + 1 || t_begin_of_data + t_methods__arraylength < t_begin_of_data )
		{
	...
	for (; t_methods__elem__it < t_methods__arraylength; ++t_methods__elem__it)
		...
		if ( t_methods__elem__dataptr + (1) > t_end_of_data || t_methods__elem__dataptr + (1) < t_methods__elem__dataptr )
			{
			// Handle out-of-bound condition
...
int SOCKS5_Auth_Message::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSOCKS * t_context)
	...
	switch ( val_case_index() )
		...
		case 0:
			...
			break;
		default:
			throw binpac::ExceptionInvalidCaseIndex("SOCKS5_Auth_Message", val_case_index());
			break;
		}
	// Evaluate 'let' and 'withinput' fields
	BINPAC_ASSERT(t_begin_of_data + (t_val__size) <= t_end_of_data);
...
int SOCKS5_Unsupported_Authentication_Method::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSOCKS * t_context)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/socks/socks-protocol.pac:56", t_crap_string_length);
...
int SOCKS5_Unsupported_Authentication_Version::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSOCKS * t_context)
	...
	// check for negative sizes
	if ( t_crap_string_length < 0 )
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/socks/socks-protocol.pac:60", t_crap_string_length);
	crap_.init(t_begin_of_data, t_crap_string_length);
	// Evaluate 'let' and 'withinput' fields
...
int SOCKS5_Auth_Request_UserPass_v1::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextSOCKS * t_context)
	...
	// Parse "ulen"
	ulen_ = *((uint8 const *) (t_begin_of_data));
	// Evaluate 'let' and 'withinput' fields
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/socks/socks-protocol.pac:73", t_username_string_length);
	...
	// Parse "plen"
	plen_ = *((uint8 const *) (t_dataptr_after_username));
	// Evaluate 'let' and 'withinput' fields
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/socks/socks-protocol.pac:75", t_password_string_length);
...
int Domain_Name::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/socks/socks-protocol.pac:104", t_name_string_length);
...
int SOCKS5_Address::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	switch ( addr_case_index() )
		...
		case 4:
			...
			if ( t_begin_of_data + t_ipv6__arraylength > t_end_of_data + 1 || t_begin_of_data + t_ipv6__arraylength < t_begin_of_data )
				{
			...
			for (; t_ipv6__elem__it < t_ipv6__arraylength; ++t_ipv6__elem__it)
				...
				if ( t_ipv6__elem__dataptr + (4) > t_end_of_data || t_ipv6__elem__dataptr + (4) < t_ipv6__elem__dataptr )
					{
					// Handle out-of-bound condition
		...
		default:
			...
			throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/analyzer/protocol/socks/socks-protocol.pac:113", t_err_string_length);
