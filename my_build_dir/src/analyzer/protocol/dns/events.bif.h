...
#if defined(BRO_IN_NETVAR) || ! defined(_home_ubuntu_bro_my_build_dir_src_analyzer_protocol_dns_events_bif)
#ifndef BRO_IN_NETVAR
#ifndef _home_ubuntu_bro_my_build_dir_src_analyzer_protocol_dns_events_bif
#define _home_ubuntu_bro_my_build_dir_src_analyzer_protocol_dns_events_bif
#include "bro-bif.h"
#endif
#endif
...
extern EventHandlerPtr dns_CAA_reply; 
namespace BifEvent {  void generate_dns_CAA_reply(analyzer::Analyzer* analyzer, Connection* c, Val* msg, Val* ans, bro_uint_t flags, StringVal* tag, StringVal* value);  } 
