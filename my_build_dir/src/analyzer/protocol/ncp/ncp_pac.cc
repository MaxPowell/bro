// This file is automatically generated from /home/ubuntu/bro/src/analyzer/protocol/ncp/ncp.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/analyzer/protocol/ncp/ncp_pac.h"
...
int ncp_request::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	for (; t_data__elem__it < t_data__arraylength; ++t_data__elem__it)
		...
		if ( t_data__elem__dataptr + (1) > t_end_of_data || t_data__elem__dataptr + (1) < t_data__elem__dataptr )
			{
...
int ncp_over_tcpip_frame::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
	...
	if ( t_begin_of_data + (t_ncp_over_tcpip_frame__size) > t_end_of_data || t_begin_of_data + (t_ncp_over_tcpip_frame__size) < t_begin_of_data )
		{
		// Handle out-of-bound condition
