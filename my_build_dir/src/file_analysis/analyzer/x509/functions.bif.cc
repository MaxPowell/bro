...
#line 222 "functions.bif"

#line 240 "functions.bif"
Val* BifFunc::bro_x509_ocsp_verify(Frame* frame, val_list* BiF_ARGS)
	
#line 241 "functions.bif"
{
...
#line 477 "functions.bif"

#line 496 "functions.bif"
Val* BifFunc::bro_x509_verify(Frame* frame, val_list* BiF_ARGS)
	
#line 497 "functions.bif"
{
...
#line 582 "functions.bif"

#line 606 "functions.bif"
Val* BifFunc::bro_sct_verify(Frame* frame, val_list* BiF_ARGS)
	
#line 607 "functions.bif"
{
	if ( BiF_ARGS->length() != 7 )
		{
		reporter->Error("sct_verify() takes exactly 7 argument(s)");
		return 0;
		}
	Val* cert = (Val*) ((*BiF_ARGS)[0]);
	StringVal* logid = (StringVal*) ((*BiF_ARGS)[1]->AsStringVal());
	StringVal* log_key = (StringVal*) ((*BiF_ARGS)[2]->AsStringVal());
	StringVal* signature = (StringVal*) ((*BiF_ARGS)[3]->AsStringVal());
	bro_uint_t timestamp = (bro_uint_t) ((*BiF_ARGS)[4]->AsCount());
	bro_uint_t hash_algorithm = (bro_uint_t) ((*BiF_ARGS)[5]->AsCount());
	StringVal* issuer_key_hash = (StringVal*) ((*BiF_ARGS)[6]->AsStringVal());
...
sct_verify_err:
	...
	return new Val(0, TYPE_BOOL);
	} // end of BifFunc::bro_sct_verify

#line 748 "functions.bif"

#line 751 "functions.bif"
...
#line 835 "functions.bif"
Val* BifFunc::bro_x509_subject_name_hash(Frame* frame, val_list* BiF_ARGS)
	
#line 836 "functions.bif"
{
	if ( BiF_ARGS->length() != 2 )
		{
		reporter->Error("x509_subject_name_hash() takes exactly 2 argument(s)");
		return 0;
		}
	Val* cert = (Val*) ((*BiF_ARGS)[0]);
	bro_uint_t hash_alg = (bro_uint_t) ((*BiF_ARGS)[1]->AsCount());
...
#line 836 "functions.bif"
	...
	} // end of BifFunc::bro_x509_subject_name_hash

#line 840 "functions.bif"

#line 853 "functions.bif"
Val* BifFunc::bro_x509_issuer_name_hash(Frame* frame, val_list* BiF_ARGS)
	
#line 854 "functions.bif"
{
	if ( BiF_ARGS->length() != 2 )
		{
		reporter->Error("x509_issuer_name_hash() takes exactly 2 argument(s)");
		return 0;
		}
	Val* cert = (Val*) ((*BiF_ARGS)[0]);
	bro_uint_t hash_alg = (bro_uint_t) ((*BiF_ARGS)[1]->AsCount());
...
#line 854 "functions.bif"
	...
	} // end of BifFunc::bro_x509_issuer_name_hash

#line 858 "functions.bif"

#line 871 "functions.bif"
Val* BifFunc::bro_x509_spki_hash(Frame* frame, val_list* BiF_ARGS)
	
#line 872 "functions.bif"
{
	if ( BiF_ARGS->length() != 2 )
		{
		reporter->Error("x509_spki_hash() takes exactly 2 argument(s)");
		return 0;
		}
	Val* cert = (Val*) ((*BiF_ARGS)[0]);
	bro_uint_t hash_alg = (bro_uint_t) ((*BiF_ARGS)[1]->AsCount());
...
#line 872 "functions.bif"
	...
	} // end of BifFunc::bro_x509_spki_hash

#line 876 "functions.bif"
