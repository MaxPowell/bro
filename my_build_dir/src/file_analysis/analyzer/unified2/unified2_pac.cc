// This file is automatically generated from /home/ubuntu/bro/src/file_analysis/analyzer/unified2/unified2.pac.
...
#include "/home/ubuntu/bro/my_build_dir/src/file_analysis/analyzer/unified2/unified2_pac.h"
...
int IDS_Event::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextUnified2 * t_context)
	...
	if ( (t_begin_of_data + 32) + (4) > t_end_of_data || (t_begin_of_data + 32) + (4) < (t_begin_of_data + 32) )
		{
		// Handle out-of-bound condition
	...
	if ( t_begin_of_data + t_src_ip__arraylength > t_end_of_data + 1 || t_begin_of_data + t_src_ip__arraylength < t_begin_of_data )
		{
	...
	for (; t_src_ip__elem__it < t_src_ip__arraylength; ++t_src_ip__elem__it)
		...
		if ( t_src_ip__elem__dataptr + (4) > t_end_of_data || t_src_ip__elem__dataptr + (4) < t_src_ip__elem__dataptr )
			{
			// Handle out-of-bound condition
...
end_of_src_ip: ;
	...
	if ( t_begin_of_data + t_dst_ip__arraylength > t_end_of_data + 1 || t_begin_of_data + t_dst_ip__arraylength < t_begin_of_data )
		{
	...
	for (; t_dst_ip__elem__it < t_dst_ip__arraylength; ++t_dst_ip__elem__it)
		...
		if ( t_dst_ip__elem__dataptr + (4) > t_end_of_data || t_dst_ip__elem__dataptr + (4) < t_dst_ip__elem__dataptr )
			{
			// Handle out-of-bound condition
...
end_of_dst_ip: ;
	...
	if ( (t_dataptr_after_dst_ip + 5) + (1) > t_end_of_data || (t_dataptr_after_dst_ip + 5) + (1) < (t_dataptr_after_dst_ip + 5) )
		{
		// Handle out-of-bound condition
...
end_of_dst_ip: ;
	...
	if ( (t_dataptr_after_dst_ip + 14) + (2) > t_end_of_data || (t_dataptr_after_dst_ip + 14) + (2) < (t_dataptr_after_dst_ip + 14) )
		{
		// Handle out-of-bound condition
...
int Packet::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextUnified2 * t_context)
	...
	if ( (t_begin_of_data + 28) + (t_packet_data__size) > t_end_of_data || (t_begin_of_data + 28) + (t_packet_data__size) < (t_begin_of_data + 28) )
		{
		// Handle out-of-bound condition
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/file_analysis/analyzer/unified2/unified2-file.pac:76", t_packet_data_string_length);
...
int ExtraData::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextUnified2 * t_context)
	...
	if ( t_begin_of_data + (t_ExtraData__size) > t_end_of_data || t_begin_of_data + (t_ExtraData__size) < t_begin_of_data )
		{
		// Handle out-of-bound condition
	...
	// Checking out-of-bound for "ExtraData:blob_len"
	if ( (t_begin_of_data + 20) + (4) > t_end_of_data || (t_begin_of_data + 20) + (4) < (t_begin_of_data + 20) )
		{
		// Handle out-of-bound condition
		throw binpac::ExceptionOutOfBound("ExtraData:blob_len",
			(20) + (4), 
			(t_end_of_data) - (t_begin_of_data));
		}
	// Parse "sensor_id"
	...
	// Checking out-of-bound for "ExtraData:blob"
	if ( (t_begin_of_data + 24) + (t_blob__size) > t_end_of_data || (t_begin_of_data + 24) + (t_blob__size) < (t_begin_of_data + 24) )
		{
		// Handle out-of-bound condition
		throw binpac::ExceptionOutOfBound("ExtraData:blob",
			(24) + (t_blob__size), 
			(t_end_of_data) - (t_begin_of_data));
		}
	{
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/file_analysis/analyzer/unified2/unified2-file.pac:86", t_blob_string_length);
...
int UnknownRecordType::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data, ContextUnified2 * t_context)
	...
	if ( t_begin_of_data + (t_UnknownRecordType__size) > t_end_of_data || t_begin_of_data + (t_UnknownRecordType__size) < t_begin_of_data )
		{
		// Handle out-of-bound condition
	...
	// Checking out-of-bound for "UnknownRecordType:data"
	if ( t_begin_of_data + (t_data__size) > t_end_of_data || t_begin_of_data + (t_data__size) < t_begin_of_data )
		{
		// Handle out-of-bound condition
		throw binpac::ExceptionOutOfBound("UnknownRecordType:data",
			(0) + (t_data__size), 
			(t_end_of_data) - (t_begin_of_data));
		}
	{
	...
	throw binpac::ExceptionInvalidStringLength("/home/ubuntu/bro/src/file_analysis/analyzer/unified2/unified2-file.pac:90", t_data_string_length);
